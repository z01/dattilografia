...
function analitza_resultat(errors)
{
	...
	if (canvi_de_dia==0)
	{
		if (hora_fi<hores[8]) {segons=segons+300;debug=debug+"&bp="+1;}
		if (hora_fi<hores[7]) {segons=segons+300;debug=debug+"&bp="+2;}
		if (hora_fi<hores[6]) {segons=segons+300;debug=debug+"&bp="+3;}
		if (hora_fi<hores[5]) {segons=segons+300;debug=debug+"&bp="+4;}
		if (hora_fi<hores[4]) {segons=segons+300;debug=debug+"&bp="+5;}
		if (hora_fi<hores[3]) {segons=segons+300;debug=debug+"&bp="+6;}
		if (hora_fi<hores[2]) {segons=segons+300;debug=debug+"&bp="+7;}
		if (hora_fi<hores[1]) {segons=segons+300;debug=debug+"&bp="+8;}
		if (hora_fi<hores[0]) {segons=segons+300;debug=debug+"&bp="+9;}
		if (hores[8]<hores[7]) {segons=segons+300;debug=debug+"&bp="+10;}
		if (hores[7]<hores[6]) {segons=segons+300;debug=debug+"&bp="+11;}
		if (hores[6]<hores[5]) {segons=segons+300;debug=debug+"&bp="+12;}
		if (hores[5]<hores[4]) {segons=segons+300;debug=debug+"&bp="+13;}
		if (hores[4]<hores[3]) {segons=segons+300;debug=debug+"&bp="+14;}
		if (hores[3]<hores[2]) {segons=segons+300;debug=debug+"&bp="+15;}
		if (hores[2]<hores[1]) {segons=segons+300;debug=debug+"&bp="+16;}
		if (hores[1]<hores[0]) {segons=segons+300;debug=debug+"&bp="+17;}
